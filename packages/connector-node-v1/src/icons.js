...
var wordFileIcon = _iconsSvg2.default.word;
var excelFileIcon = _iconsSvg2.default.excel;
var powerpointFileIcon = _iconsSvg2.default.powerpoint;
...
var pictureFilesExtensions = ['gif', 'png', 'jpg', 'jpeg', 'bmp', 'svg','tif'];
...
var wordFilesExtensions = ['doc', 'docx'];
var excelFilesExtensions = ['xls', 'xlsx','xlsm'];
var powerpointFilesExtensions = ['ppt', 'pptx','pptm'];
...
function getIcon(resource) {
  ...
  } else if (matchFileExtensions(resource.name, wordFilesExtensions)) {
    return { svg: wordFileIcon, fill: '#e53935' }; 	
  } else if (matchFileExtensions(resource.name, excelFilesExtensions)) {
    return { svg: excelFileIcon, fill: '#e53935' }; 		
  } else if (matchFileExtensions(resource.name, powerpointFilesExtensions)) {
    return { svg: powerpointFileIcon, fill: '#e53935' }; 			
  } else {
